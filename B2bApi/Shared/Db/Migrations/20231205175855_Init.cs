        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    table = table.Column<string>(type: "char(1)", nullable: false),
                    date = table.Column<DateTime>(type: "date", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_exchange_rates", x => x.no);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    mid = table.Column<decimal>(type: "numeric(6,4)", nullable: false),
                    bid = table.Column<decimal>(type: "numeric(6,4)", nullable: false),
                    ask = table.Column<decimal>(type: "numeric(6,4)", nullable: false),
                    exchange_rate_no = table.Column<string>(type: "varchar(20)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_rates", x => x.id);
                    table.ForeignKey(
                        name: "FK_rates_exchange_rates_exchange_rate_no",
                        column: x => x.exchange_rate_no,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_availabilities_products_product_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_availabilities_product_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_rates_exchange_rate_no",
                table: "rates",
